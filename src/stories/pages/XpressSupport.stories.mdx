...
<Meta title="Pages/XpressSupport" component={XpressView} />
        ...
        <XpressView
            ...
            breadcrumb={
                <Breadcrumb
                    ...
                    lists={
                        [
                            { state: 'active', link: <Link theme="red" variant="light-gh" cls="white">Help &#38; support</Link>}
                        ]
                    }
                />
            }
            content={
                <h1 className="theme-red" style={{color: "#fff", fontSize: "42px", letterSpacing: "1.3px", lineHeight: "48px;"}}>Help &#38; support</h1>
            }
        />
    </Story>
</Canvas>